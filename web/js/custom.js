...
// toggle small or large menu
    ...
    if ($.fn.mCustomScrollbar) {
        $('.menu_fixed').mCustomScrollbar({
            autoHideScrollbar: true, theme: 'minimal', mouseWheel: {preventDefault: true}
        });
    }
};
// /Sidebar
...
function init_flot_chart() {
    ...
    var chart_plot_01_settings = {
        series: {
            lines: {
                show: false, fill: true
            }, splines: {
                show: true, tension: 0.4, lineWidth: 1, fill: 0.4
            }, points: {
                radius: 0, show: true
            }, shadowSize: 2
        }, grid: {
            verticalLines: true, hoverable: true, clickable: true, tickColor: "#d5d5d5", borderWidth: 1, color: '#fff'
        }, colors: ["rgba(38, 185, 154, 0.38)", "rgba(3, 88, 106, 0.38)"], xaxis: {
            tickColor: "rgba(51, 51, 51, 0.06)",
            mode: "time",
            tickSize: [1, "day"], //tickLength: 10,
            axisLabel: "Date",
    ...
    var chart_plot_02_settings = {
        ...
        series: {
            lines: {
                ...
                show: true, radius: 4.5, symbol: "circle", lineWidth: 3.0
            }
        },
        legend: {
            position: "ne",
    ...
    if ($("#chart_plot_02").length) {
        ...
        $.plot($("#chart_plot_02"), [{
            label: "Email Sent", data: chart_plot_02_data, lines: {
    ...
    if ($("#chart_plot_03").length) {
        ...
        $.plot($("#chart_plot_03"), [{
            label: "Registrations", data: chart_plot_03_data, lines: {
                fillColor: "rgba(150, 202, 89, 0.12)"
            }, points: {
                fillColor: "#fff"
            }
...
function init_gauge() {
    ...
    var chart_gauge_settings = {
        ...
        lineWidth: 0.4,
        pointer: {
            length: 0.75, strokeWidth: 0.042, color: '#1D212A'
        },
        limitMax: 'false',
        colorStart: '#1ABC9C',
        colorStop: '#1ABC9C',
...
function init_select2() {
    ...
    $(".select2_multiple").select2({
        maximumSelectionLength: 4, placeholder: "With Max Selection limit 4", allowClear: true
    });
...
function init_wysiwyg() {
    ...
    $('.editor-wrapper').each(function () {
        ...
        $(this).wysiwyg({
            toolbarSelector: '[data-target="#' + id + '"]', fileUploadError: showErrorAlert
        });
    });
...
function init_IonRangeSlider() {
    ...
    $("#range_27").ionRangeSlider({
        type: "double", min: 1000000, max: 2000000, grid: true, force_edges: true
    });
    ...
    $("#range_25").ionRangeSlider({
        type: "double", min: 1000000, max: 2000000, grid: true
    });
    $("#range_26").ionRangeSlider({
        type: "double", min: 0, max: 10000, step: 500, grid: true, grid_snap: true
    });
    $("#range_31").ionRangeSlider({
        type: "double", min: 0, max: 100, from: 30, to: 70, from_fixed: true
    });
...
function init_daterangepicker_single_call() {
    ...
    $('#single_cal2').daterangepicker({
        singleDatePicker: true, singleClasses: "picker_2"
    }, function (start, end, label) {
        console.log(start.toISOString(), end.toISOString(), label);
    });
    $('#single_cal3').daterangepicker({
        singleDatePicker: true, singleClasses: "picker_3"
    }, function (start, end, label) {
        console.log(start.toISOString(), end.toISOString(), label);
    });
    $('#single_cal4').daterangepicker({
        singleDatePicker: true, singleClasses: "picker_4"
    }, function (start, end, label) {
        console.log(start.toISOString(), end.toISOString(), label);
    });
...
function init_charts() {
    ...
    if ($('#canvasDoughnut').length) {
        ...
        var canvasDoughnut = new Chart(ctx, {
            type: 'doughnut', tooltipFillColor: "rgba(51, 51, 51, 0.55)", data: data
        });
...
function init_calendar() {
    ...
    var calendar = $('#calendar').fullCalendar({
        header: {
            ...
            $(".antosubmit").on("click", function () {
                ...
                if (title) {
                    calendar.fullCalendar('renderEvent', {
                                title: title, start: started, end: end, allDay: allDay
            ...
            title: 'Lunch', start: new Date(y, m, d + 14, 12, 0), end: new Date(y, m, d, 14, 0), allDay: false
        }, {
    ...
    var theme = {
        ...
        valueAxis: {
            ...
            lineStyle: {
                ...
                normal: {color: '#408829'}, emphasis: {color: '#408829'}
            }
        },
        ...
        k: {
            ...
            startAngle: 225, endAngle: -45, axisLine: {
                show: true, lineStyle: {
                    color: [[0.2, '#86b379'], [0.8, '#68a54a'], [1, '#408829']], width: 8
                }
            }, axisTick: {
    ...
    if ($('#echart_gauge').length) {
        ...
        echartGauge.setOption({
            tooltip: {
                ...
                axisLine: {
                    show: true, lineStyle: {
                        color: [[0.2, 'lightgreen'], [0.4, 'orange'], [0.8, 'skyblue'], [1, '#ff4500']], width: 30
                    }
                },
                axisTick: {
                    show: true, splitNumber: 5, length: 8, lineStyle: {
                ...
                title: {
                    show: true, offsetCenter: ['-65%', -10], textStyle: {
    ...
    if ($('#echart_line').length) {
        ...
        echartLine.setOption({
            title: {
                ...
                name: 'Deal', type: 'line', smooth: true, itemStyle: {
                    normal: {
                        areaStyle: {
                            type: 'default'
                        }
                ...
                name: 'Pre-order', type: 'line', smooth: true, itemStyle: {
                    normal: {
                        areaStyle: {
                            type: 'default'
                        }
                ...
                name: 'Intent', type: 'line', smooth: true, itemStyle: {
                    normal: {
                        areaStyle: {
                            type: 'default'
                        }
    ...
    if ($('#echart_scatter').length) {
        ...
        echartScatter.setOption({
            title: {
                ...
                type: 'value', scale: true, axisLabel: {
                    formatter: '{value} cm'
                }
            }], yAxis: [{
                type: 'value', scale: true, axisLabel: {
    ...
    if ($('#echart_bar_horizontal').length) {
        ...
        echartBar.setOption({
            title: {
                ...
                name: '2016', type: 'bar', data: [19325, 23438, 31000, 121594, 134141, 681807]
            }]
        });
            ...
            title: {
                ...
                show: true, feature: {
                    mark: {
                        ...
                        show: true, title: "Text View", lang: ["Text View", "Close", "Refresh"], readOnly: false
                    }, restore: {
                        show: true, title: "Restore"
                    }, saveAsImage: {
                        show: true, title: "Save Image"
                ...
                name: '1', type: 'pie', clockWise: false, radius: [105, 130], itemStyle: dataStyle, data: [{
                    value: 68, name: '68%Something #1'
                }, {
                    value: 32, name: 'invisible', itemStyle: placeHolderStyle
                }]
            }, {
                name: '2', type: 'pie', clockWise: false, radius: [80, 105], itemStyle: dataStyle, data: [{
                    value: 29, name: '29%Something #2'
                }, {
                    value: 71, name: 'invisible', itemStyle: placeHolderStyle
                }]
            }, {
                name: '3', type: 'pie', clockWise: false, radius: [25, 80], itemStyle: dataStyle, data: [{
                    value: 3, name: '3%Something #3'
                }, {
                    value: 97, name: 'invisible', itemStyle: placeHolderStyle
                }]
            }]
        });
    ...
    if ($('#echart_world_map').length) {
        ...
        echartMap.setOption({
            title: {
                ...
                name: 'World Population (2010)', type: 'map', mapType: 'world', roam: false, mapLocation: {
                    y: 60
                }, itemStyle: {
                    emphasis: {
                        label: {
